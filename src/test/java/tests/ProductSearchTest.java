...
public class ProductSearchTest extends BaseTest {
    ...
    public void searchByQuery(String search) throws IOException {
        assertThat(new LoginPage(BaseTest.driver).get()
                .login()
                .openGoodsPage()
                .writeSearchQuery(search)
                .getGoodElementFromList(0)
                .getName())
                .isNotNull()
    ...
    class ProductSearchAccordingToPriceTest {
        ...
        public void searchInPriceRange(String search, String min, String max) throws IOException {
            GoodsPage goodsPage = new LoginPage(BaseTest.driver).get()
                    .login()
                    .openGoodsPage()
                    .writeSearchQuery(search);

            assertThat(goodsPage
                    .setMinPrice(min)
                    .setMaxPrice(max)
                    .checkPrice(Integer.parseInt(min), Integer.parseInt(max)))
                    .as("Цена не в диапазоне")
                    .isTrue();
        }
    ...
    class ProductSearchAccordingToSortingTest {
        ...
        public void searchByCriterion(String search) throws IOException {
            ...
            assertThat(goodsPage
                    .chooseSort(Criteria.CHEAP)
                    .isCheapSort())
                    .as("Cортировка не %s", Criteria.CHEAP.toString())
                    .isTrue();
        }
    }
}
